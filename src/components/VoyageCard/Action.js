...
const voyageActionSwitch = (userStatus, routeParam) => {
  switch (userStatus) {
    case 'voyage_ready':
      return {
        to: `/voyage/application/${routeParam}`,
        query: dynamicFormQuery,
        variables: { voyage_id: routeParam, purpose: 'voyage_application', version: null },
      };
    case 'profile_complete':
      return {
        to: `/voyage/application/${routeParam}`,
        query: dynamicFormQuery,
        variables: { voyage_id: routeParam, purpose: 'new_voyage_user', version: null },
      };
