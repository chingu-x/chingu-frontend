...
class BugSuggestion extends React.Component {
  ...
  submitTicket = feedback_data => {
    const mutation = gql`
      mutation createFeedback($feedback_data: FeedbackCreateInput!) {
...
export default props => (
  <Request {...props} query={siteLocationEnumQuery} component={BugSuggestion} loader />
);
