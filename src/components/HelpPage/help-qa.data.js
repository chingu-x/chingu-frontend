...
export const HelpQA = [
  {
    ...
    qa_set: [
      ...
      },
      {
        ...
        answer: `Open to collaboration, accountable, and hungry to level-up their skills. ${<br />} As far as skill and experience 
                level, if 0 is just started to learn today and 100 is got a developer job, Chingu members come from the 
                15 - 150 range. New learners who have built a project or two → experienced professional developers 
                learning new skills (new frameworks, leadership, mentorship). 
                `
      }
    ]
  },
    ...
    qa_set: [
      {
        ...
        answer: `In a typical Voyage, you can expect to have the opportunity to earn various Hard and Soft skills. 
                ${<br />}
                ${<br />}
      ...
      },
      {
        ...
        answer: `Yes, Chingu is tech-stack agnostic and the team decides together what tech-stack to use.
                ${<br />}
